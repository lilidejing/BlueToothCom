...
public class BluetoothChatService {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothActivity.TOAST, "设备连接失败");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothActivity.TOAST, "设备连接已断开");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
            ...
            while (true) {
              ////synchronized(this)
              {
                try {
                    ...
                    for(int inlen=0; inlen<bytes; inlen++){
//                    	if(true) Log.d("BlueChat",inlen+":"+Integer.toHexString((buffer[inlen]&0xff)));
                    }
...
//                    msg.what = BluetoothActivity.MESSAGE_READ;
//                    msg.arg1 = bytes;
//                    msg.obj = buffer;  
//                    msg.sendToTarget();
                ...
                try{
                	sleep(300);  //wait 300ms for receive handle
                }catch(Exception e){
                	e.printStackTrace();
                }
              }  
